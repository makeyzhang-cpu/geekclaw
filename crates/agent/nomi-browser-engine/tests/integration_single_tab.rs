...
//!   cargo test -p geekclaw-browser-engine --test integration_single_tab
...
use geekclaw_browser_engine::profile::OWNERSHIP_MARKER_FILE;
...
async fn chrome_self_exits_when_command_pipe_closes() {
    ...
    let cfg = LaunchConfig {
        chrome_path: chrome,
        user_data_dir: std::env::temp_dir().join("geekclaw-pipe-selfexit-profile"),
        headful: false,
    };
