...
pub struct CompactConfig {
    ...
    #[serde(default)]
    pub compaction: geekclaw_compact::CompactionLevel,
...
impl Default for CompactConfig {
    fn default() -> Self {
        Self {
            ...
            compaction: geekclaw_compact::CompactionLevel::default(),
            toon: false,
        }
    }
}
...
///
/// GeekClaw's defaults target a 200k context window. Reusing them unchanged for a
...
"#;
    ...
    fn default_compaction_is_safe() {
        let cfg = CompactConfig::default();
        assert_eq!(cfg.compaction, geekclaw_compact::CompactionLevel::Safe);
    }
    ...
    fn toml_compaction_level_override() {
        ...
        let cfg: CompactConfig = toml::from_str(toml_str).unwrap();
        assert_eq!(cfg.compaction, geekclaw_compact::CompactionLevel::Full);
    }
    ...
    fn toml_compaction_off() {
        ...
        let cfg: CompactConfig = toml::from_str(toml_str).unwrap();
        assert_eq!(cfg.compaction, geekclaw_compact::CompactionLevel::Off);
    }
