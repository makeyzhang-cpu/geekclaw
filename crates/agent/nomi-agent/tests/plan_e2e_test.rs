...
use geekclaw_agent::plan::prompt::plan_mode_instructions;
use geekclaw_agent::plan::tools::{EnterPlanModeTool, ExitPlanModeTool};
use geekclaw_protocol::events::ToolCategory;
use geekclaw_tools::Tool;
use geekclaw_tools::registry::ToolRegistry;
use geekclaw_types::skill_types::PlanModeTransition;
use serde_json::json;
...
fn tc_3_6_e2e_02_plan_mode_and_compaction_independent() {
    use geekclaw_agent::compact::micro::microcompact;
    use geekclaw_agent::plan::state::PlanState;
