...
//! touch the local filesystem or process runtime. `geekclaw-process-runtime`'s
...
fn the_ssh_seam_names_no_backend_type() {
    ...
    for forbidden in ["nomifun_", "geekclaw-", "SshLinkKey", "SshHostId"] {
        assert!(
