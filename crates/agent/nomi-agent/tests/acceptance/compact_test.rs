...
use geekclaw_agent::compact::auto::{BOUNDARY_PREFIX, autocompact, should_autocompact};
use geekclaw_agent::compact::emergency::is_at_emergency_limit;
use geekclaw_agent::compact::micro::{CLEARED_TOOL_RESULT, microcompact};
use geekclaw_agent::compact::state::CompactState;
