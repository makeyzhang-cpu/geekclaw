...
use geekclaw_agent::confirm::ToolConfirmer;
use geekclaw_agent::engine::AgentEngine;
use geekclaw_agent::tool_execution::{ProviderToolAuthority, execute_tool_calls_scoped};
use geekclaw_agent::output::OutputSink;
use geekclaw_agent::output::null_sink::NullSink;
use geekclaw_compact::CompactionLevel;
...
impl geekclaw_tools::Tool for FixedOutputTool {
    fn name(&self) -> &str {
        &self.name
    }
