...
use geekclaw_agent::session::{EditableTurnCheckpoint, Session, SessionManager};
use geekclaw_config::compat::ProviderCompat;
use geekclaw_protocol::events::ToolCategory;
use geekclaw_providers::openai::OpenAIProvider;
...
async fn plan_mode_rejects_registered_write_tool_omitted_from_provider_request() {
    ...
    registry.register(Box::new(
        geekclaw_agent::plan::tools::EnterPlanModeTool::new(Arc::clone(&plan_active)),
    ));
