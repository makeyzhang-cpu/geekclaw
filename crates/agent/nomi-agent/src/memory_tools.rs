...
//! self-contained in the agent layer (writes via `geekclaw_memory`); the host wires
...
use geekclaw_memory::index::append_index_entry;
use geekclaw_memory::paths::ENTRYPOINT_NAME;
use geekclaw_memory::store::write_memory;
...
impl Tool for RememberTool {
    ...
    fn describe(&self, input: &Value) -> String {
        ...
        format!("Remember: {}", geekclaw_tools::truncate_utf8(title, 60))
    }
}
