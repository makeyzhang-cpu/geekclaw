...
use geekclaw_types::agent::{AgentInvocationInput, AgentInvocationOutput};
...
fn bounded_preview(value: &str, max_bytes: usize) -> String {
    ...
    let preview = geekclaw_tools::truncate_utf8(&normalized, max_bytes);
...
mod tests {
    use super::*;
    use geekclaw_types::agent::AgentToolPolicy;
