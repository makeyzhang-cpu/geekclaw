...
use geekclaw_config::shell::SupervisedShell;
use geekclaw_protocol::events::ToolCategory;
use geekclaw_skills::context_modifier::ContextModifier;
use geekclaw_skills::executor::{
    execute_fork_with_shell, prepare_inline_content_with_shell,
};
use geekclaw_skills::hooks::{parse_skill_hooks, to_hook_defs};
use geekclaw_skills::permissions::{SkillPermission, SkillPermissionChecker};
use geekclaw_skills::types::{ExecutionContext, SkillMetadata};
use geekclaw_types::agent::AgentInvocationRunner;
...
impl Tool for SkillTool {
    ...
    fn context_modifier_for(&self, input: &serde_json::Value) -> Option<ContextModifier> {
        ...
        geekclaw_skills::context_modifier::from_skill(skill)
    }
...
mod tests {
    use super::*;
    use geekclaw_skills::permissions::SkillPermissionChecker;
    use geekclaw_skills::types::{ExecutionContext, LoadedFrom, SkillSource};
    use serde_json::json;
...
mod supplemental_tests {
    ...
    use geekclaw_skills::permissions::SkillPermissionChecker;
    use geekclaw_skills::types::{ExecutionContext, LoadedFrom, SkillMetadata, SkillSource};
