...
// Re-export the skills crate so existing callers (geekclaw-cli, tests) can use
// `geekclaw_agent::skills::` without changing their import paths.
pub use geekclaw_skills as skills;
