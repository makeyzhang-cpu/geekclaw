...
//!    adapts this trait to the engine's [`geekclaw_browser_engine::firewall::EgressApprover`]).
//!
...
//! gateway (the GW2 `geekclaw_browser_confirm` pending channel).
//!
//! # Security keystone
//!
...
use geekclaw_browser_engine::firewall::{EgressApprover, EgressVerdict, PostPreview};
