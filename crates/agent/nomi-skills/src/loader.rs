...
pub async fn load_all_skills(
    ...
    // project-owned `.geekclaw/commands` remains an explicit workspace input.
...
///
/// Examples:
/// - base=`<config_dir>/geekclaw/skills`, target=`<config_dir>/geekclaw/skills/db/migrate` → `"db:migrate"`
/// - base=`<config_dir>/geekclaw/skills`, target=`<config_dir>/geekclaw/skills/my-skill` → `"my-skill"`
