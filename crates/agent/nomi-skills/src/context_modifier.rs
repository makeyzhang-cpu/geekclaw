...
// Re-export from geekclaw-types so callers can use a single import path
pub use geekclaw_types::skill_types::{ContextModifier, effort_to_string};
...
mod tests {
    ...
    use geekclaw_types::skill_types::EffortLevel;
