...
// Re-export EffortLevel from geekclaw-types (single source of truth)
pub use geekclaw_types::skill_types::EffortLevel;
...
pub enum SkillSource {
    /// `<config_dir>/geekclaw/skills/`
    User,
    /// .geekclaw/skills/ (project-level)
    Project,
    /// .geekclaw/.managed/skills/
    Managed,
    /// Built-in bundled skills
    Bundled,
    /// Loaded via MCP protocol
    Mcp,
    /// .geekclaw/commands/ (legacy compatibility)
    Legacy,
}
