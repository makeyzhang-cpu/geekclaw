//! Cross-platform accessibility-tree + Set-of-Marks engine for GeekClaw computer-use.
//!
...
/// "GeekClaw"); library/headless embeddings leave it unset and get "this app".
...
/// "GeekClaw"). Last writer wins; call once early in host startup. A poisoned
...
mod host_label_tests {
    ...
    fn label_defaults_then_reflects_set_and_ignores_empty() {
        ...
        set_host_app_label("GeekClaw");
        assert_eq!(host_app_label(), "GeekClaw");
