...
fn make_factory_with_summon(
    ...
    build_agent_factory(AgentFactoryDeps {
        ...
        agent_registry,
        acp_agent_service,
        data_dir: PathBuf::from("/tmp/geekclaw-test"),
        work_dir: PathBuf::from("/tmp/geekclaw-test"),
        backend_binary_path: Arc::new(PathBuf::from("/tmp/geekclaw-test/geekclaw")),
