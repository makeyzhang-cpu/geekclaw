...
const ARTIFACT_DIRECTORY: &str = "geekclaw-artifacts";
...
impl ArtifactStore {
        ...
        P: AsRef<Path>,
    {
        ...
        // being inspected therefore aborts before `geekclaw-artifacts` exists.
...
mod tests {
    ...
    fn persists_and_reads_back_valid_image() {
        ...
        assert!(artifact.relative_path.starts_with("geekclaw-artifacts/"));
