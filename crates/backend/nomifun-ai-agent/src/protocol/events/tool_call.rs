...
pub fn validate_completed_artifact_contract(data: &ToolCallEventData) -> Result<(), String> {
    ...
    let contract = geekclaw_agent::output::artifact_contract_with_input(&data.name, &data.args)
...
mod tests {
    ...
    fn duplicate_canonical_path_cannot_satisfy_requested_count() {
        let result = validate_completed_artifact_contract(&completed_images(vec![
            image("/workspace/a.png", "geekclaw-artifacts/a.png"),
            image("/workspace/a.png", "geekclaw-artifacts/alias.png"),
        ]));
    ...
    fn empty_artifact_id_cannot_satisfy_requested_count() {
        let mut first = image("/workspace/a.png", "geekclaw-artifacts/a.png");
        first.id = "   ".to_owned();
        let result = validate_completed_artifact_contract(&completed_images(vec![
            first,
            image("/workspace/b.png", "geekclaw-artifacts/b.png"),
        ]));
    ...
    fn duplicate_artifact_id_cannot_satisfy_requested_count() {
        let first = image("/workspace/a.png", "geekclaw-artifacts/a.png");
        let mut second = image("/workspace/b.png", "geekclaw-artifacts/b.png");
    ...
    fn duplicate_relative_path_cannot_satisfy_requested_count() {
        let mut second = image("/workspace/b.png", "geekclaw-artifacts/a.png");
