...
const INIT_TIMEOUT_ENV: &str = "GEEKCLAW_ACP_INIT_TIMEOUT_SECS";
...
/// Log a JSON-RPC request from GeekClaw to the ACP agent.
...
/// Log a fire-and-forget notification from GeekClaw to the agent.
...
/// Log a JSON-RPC response from GeekClaw back to the agent.
