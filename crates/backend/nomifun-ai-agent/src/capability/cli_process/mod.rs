...
use geekclaw_process_runtime::{ChildProcessCleanup, kill_process_tree};
...
pub struct CliAgentProcess {
    ...
    identity: Option<geekclaw_process_runtime::ExactProcessIdentity>,
...
impl CliAgentProcess {
    ...
    pub fn identity(&self) -> Option<&geekclaw_process_runtime::ExactProcessIdentity> {
