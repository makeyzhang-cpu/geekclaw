...
struct MemoryUpdateParams {
    /// The stable business id of the memory to update (from geekclaw_memory_list).
...
struct MemoryDeleteParams {
    ...
    /// archiving via geekclaw_memory_update unless the user explicitly asked to delete.
    #[schemars(schema_with = "crate::id_schema::canonical_uuid_v7_schema")]
    memory_id: CompanionMemoryId,
}
...
pub(crate) fn register(out: &mut Vec<Capability>) {
    ...
    out.push(Capability::new::<MemoryDeleteParams, _, _>(
        CapabilityMeta::new(
            ...
            "memory",
            "Permanently delete a memory. Prefer archiving via geekclaw_memory_update unless the user asked to delete.",
...
mod tests {
    ...
    fn memory_mutation_tool_schemas_expose_named_business_ids() {
        ...
        for name in ["geekclaw_memory_update", "geekclaw_memory_delete"] {
