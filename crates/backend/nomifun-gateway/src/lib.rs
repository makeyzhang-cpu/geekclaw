...
//! that exposes the whole GeekClaw Desktop capability surface (conversations,
...
//! `geekclaw mcp-gateway-stdio` bridge (claude / codex / gemini advertise
//! stdio-only MCP capabilities; the geekclaw engine consumes the same bridge), and
