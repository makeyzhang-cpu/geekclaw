...
//!
//! - `geekclaw_mcp_test_connection` — requires building a `McpServerTransport`
...
struct McpEditServerParams {
    /// Stable MCP server business id (from geekclaw_mcp_list_servers).
...
// ══════════════════════════════════════════════════════════════════════════════
//
// 1. `geekclaw_mcp_test_connection` (Read/Write)
