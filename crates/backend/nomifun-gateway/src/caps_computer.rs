...
//! in-tree `geekclaw_computer::ComputerTool`, mirroring the inward
...
#[serde(deny_unknown_fields)]
struct RefParams {
    /// Element number `[ref]` from the most recent `geekclaw_computer_snapshot`.
    r#ref: u32,
}
...
pub(crate) fn register(out: &mut Vec<Capability>) {
    ...
    out.push(Capability::new::<RefParams, _, _>(
        CapabilityMeta::new(
            "geekclaw_computer_double_click",
            "computer",
    ...
    out.push(Capability::new::<NoParams, _, _>(
        CapabilityMeta::new(
            "geekclaw_computer_list_windows",
            "computer",
    ...
    out.push(Capability::new::<NoParams, _, _>(
        CapabilityMeta::new(
            "geekclaw_computer_cursor_position",
            "computer",
