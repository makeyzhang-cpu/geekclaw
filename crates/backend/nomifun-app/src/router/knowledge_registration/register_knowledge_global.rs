...
pub fn register_global(family: AgentCli, geekclaw: &str) -> io::Result<RegisterOutcome> {
    match family {
...
mod tests {
    ...
    fn register_unregister_roundtrip_preserves_other_fields() {
        ...
        .unwrap();
        merge_registration_file(&path, AgentCli::Claude, "/bin/geekclaw").unwrap();
