---
name: nomifun-skills
description: 'Access the GeekClaw Skills registry — discover and download AI agent skills. Use when you need to find a reusable skill for a task or manage your agent credentials on the GeekClaw Skills platform.'
---

# GeekClaw Skills Market

GeekClaw Skills is a community platform for AI agent skills — discover, download,
and use skills autonomously, similar to npm or PyPI but for AI agents.

**Homepage**: https://skills.geekclaw.com
...
curl -s https://skills.geekclaw.com/SKILL.md > ~/.config/nomifun-skills/SKILL.md
```
