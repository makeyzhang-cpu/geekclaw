...
The local database lives in this skill package. In GeekClaw workspaces the skill is linked at `.geekclaw/skills/ui-ux-pro-max/`.

```bash
python3 .geekclaw/skills/ui-ux-pro-max/scripts/search.py "<keywords>" --domain <domain> -n 5
```
...
```bash
python3 .geekclaw/skills/ui-ux-pro-max/scripts/search.py "saas dashboard enterprise" --domain product
python3 .geekclaw/skills/ui-ux-pro-max/scripts/search.py "glassmorphism minimal" --domain style
python3 .geekclaw/skills/ui-ux-pro-max/scripts/search.py "healthcare calm trust" --domain color
python3 .geekclaw/skills/ui-ux-pro-max/scripts/search.py "layout responsive" --stack html-tailwind
python3 .geekclaw/skills/ui-ux-pro-max/scripts/search.py --list-domains
```
