...
//!
//! This test reproduces the user's exact gesture — a plain desktop geekclaw
...
/// GeekClaw conversations require a canonical persisted provider/model binding
...
async fn idmm_recovers_and_confirms_on_arm_pending_tool_confirmation() {
    ...
    // A plain desktop geekclaw conversation (no channel/companion markers, no
    ...
    // (geekclaw-knowledge workspace_binding.rs, canonical_workspace_key).
