...
fn command_not_found_message(command: &str) -> String {
    match missing_command_runtime(command) {
        "node" => format!(
            "Command not found: {command}. Install Node.js (which includes npm/npx), then restart GeekClaw or configure this MCP server to use an absolute command path."
        ),
        "bun" => format!(
            "Command not found: {command}. Install Bun (which includes bun/bunx), then restart GeekClaw or configure this MCP server to use an absolute command path."
        ),
        "uv" => format!(
            "Command not found: {command}. Install uv, then restart GeekClaw or configure this MCP server to use an absolute command path."
        ),
        "python" => format!(
            "Command not found: {command}. Install Python, then restart GeekClaw or configure this MCP server to use an absolute command path."
        ),
        "deno" => format!(
            "Command not found: {command}. Install Deno, then restart GeekClaw or configure this MCP server to use an absolute command path."
        ),
        _ => format!(
