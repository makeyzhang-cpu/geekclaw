...
impl AgentType {
    ...
    pub fn native_skills_dirs(&self) -> Option<&'static [&'static str]> {
        match self {
            AgentType::GeekClaw => Some(&[".geekclaw/skills"]),
            AgentType::Acp
...
mod tests {
    ...
    fn test_agent_type_display_names() {
        ...
        assert_eq!(AgentType::GeekClaw.display_name(), "GeekClaw");
    ...
    fn test_mcp_source_serde_roundtrip() {
        let cases = [
            ...
            (McpSource::GeekClaw, r#""geekclaw""#),
            (McpSource::Nanobot, r#""nanobot""#),
            (McpSource::Nomifun, r#""geekclaw""#),
        ];
    ...
    fn agent_type_full_auto_mode_id_supports_non_acp_agents() {
        ...
        assert_eq!(AgentType::GeekClaw.full_auto_mode_id(None), "yolo");
