...
pub(super) const SNAPSHOT_DIR_PREFIX: &str = "geekclaw-snapshot-";
...
const SNAPSHOT_SIG_NAME: &str = "geekclaw";
/// Signature email used for snapshot commits.
const SNAPSHOT_SIG_EMAIL: &str = "snapshot@geekclaw.local";
...
pub(super) struct WorkspaceState {
    ...
    /// - snapshot mode: `/tmp/geekclaw-snapshot-{hash}` (bare-style git dir).
