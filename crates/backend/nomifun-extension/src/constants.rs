...
pub const EXTENSION_MANIFEST_FILE: &str = "geekclaw-extension.json";
...
pub const RESERVED_NAME_PREFIXES: &[&str] = &["geekclaw-", "internal-", "builtin-", "system-"];
...
/// Well-known skill source name for the geekclaw skills market.
pub const SKILLS_MARKET_NAME: &str = "nomifun-skills";

/// Well-known skill source path for the geekclaw skills market.
///
...
pub const SKILLS_MARKET_PATH: &str = "https://github.com/geekclaw/nomifun-skills";
...
mod tests {
    ...
    fn test_manifest_file_name() {
        assert_eq!(EXTENSION_MANIFEST_FILE, "geekclaw-extension.json");
    }

    #[test]
    fn test_reserved_prefixes_contains_expected() {
        assert!(RESERVED_NAME_PREFIXES.contains(&"geekclaw-"));
