...
const EXTENSION_STATES_FILE_ENV: &str = "GEEKCLAW_EXTENSION_STATES_FILE";
...
/// Resolve the extension state file path using the historical GeekClaw rules.
///
/// Priority:
/// 1. `GEEKCLAW_EXTENSION_STATES_FILE`
