...
///
/// Data is stored in `~/.geekclaw/custom-skill-paths.json`.
...
impl ExternalPathsManager {
    ...
    /// Enable the geekclaw skills market by adding it to external paths.
    ...
    /// Disable the geekclaw skills market by removing it from external paths.
