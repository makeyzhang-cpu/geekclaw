...
/// (`GEEKCLAW_BUILTIN_SKILLS_PATH`) is consulted at runtime for rapid
...
pub const BUILTIN_SKILLS_ENV_VAR: &str = "GEEKCLAW_BUILTIN_SKILLS_PATH";
...
pub struct SkillPaths {
    /// Root data directory (~/.geekclaw/).
    pub data_dir: PathBuf,
    /// User-created skills directory (~/.geekclaw/skills/).
    pub user_skills_dir: PathBuf,
    /// Per-job cron skills directory (~/.geekclaw/cron/skills/).
    ...
    /// Preset-level rules directory (~/.geekclaw/preset-rules/).
    pub preset_rules_dir: PathBuf,
    /// Preset-level skills directory (~/.geekclaw/preset-skills/).
...
///
/// `data_dir` is the user-level data root (e.g. `~/.geekclaw/`) and
