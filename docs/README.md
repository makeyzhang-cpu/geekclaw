# GeekClaw Documentation

This folder contains the current technical, operator, and contributor
documentation for **GeekClaw**. Normative current behavior lives under
...
| Need | Read |
| --- | --- |
| Understand what GeekClaw is | [getting-started/introduction.md](getting-started/introduction.md) |
