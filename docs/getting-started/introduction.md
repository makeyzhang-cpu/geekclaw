...
**GeekClaw** is an open-source AI workstation and coding workspace. It unifies
...
![GeekClaw guide / landing page](../images/gs-01-introduction-hero.png)

## What GeekClaw Solves

Modern AI workflows are scattered across separate CLIs, terminals, browser
tabs, MCP servers, and local scripts. GeekClaw pulls them into one workspace:

- **Many agents, one surface.** Use the built-in GeekClaw engine or external
...
GeekClaw is not a no-code SaaS chat product. It is infrastructure for users who
...
| --- | --- | --- | --- |
| Desktop app | `geekclaw-desktop` | Per-boot local trust token injected into the desktop webview | Personal workstation |
...
- **Desktop Companion** (`/geekclaw`): companion configuration, memory, and remote binding.
...
GeekClaw is in active development. [STATUS.md](../../STATUS.md) is the compact
current-state snapshot. Design and audit history is not kept in the repo; consult
git history for past decisions.

## License

GeekClaw is released under the Apache-2.0 License. See
