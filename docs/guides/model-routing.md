...
It lets GeekClaw-engine conversations try a configured sequence of backup models
...
- Applies only to GeekClaw-engine conversations.
...
Use model failover when a GeekClaw-engine session should recover from transient
