...
| Agent | An executable backend such as GeekClaw, Codex, Claude, Gemini, or a remote agent | A reusable user configuration |
...
`preset-avatars/` under the GeekClaw data directory. Deleting a user preset also
