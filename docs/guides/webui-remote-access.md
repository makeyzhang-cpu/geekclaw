...
- **Default port `25808`** (`25809` in dev mode, `25810` when `GEEKCLAW_MULTI_INSTANCE=1`).
...
| Admin provisioning | Auto-generated password on first enable | Interactive first-run setup, or `GEEKCLAW_ADMIN_PASSWORD` |
...
| TLS | None built in (LAN-oriented) | Caddy / nginx in front; `GEEKCLAW_HTTPS=true` |
