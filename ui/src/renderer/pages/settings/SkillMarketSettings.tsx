 ...
 * never auto-sent installation draft to GeekClaw via the quick-start flow.
 */
...
const CACHE_KEY = 'geekclaw.skillMarket.rankings.v4';
const AUTO_SYNC_KEY = 'geekclaw.skillMarket.autoSynced.v4';
      ...
      <div className='space-y-16px pb-24px'>
        <MarketSettingsPanel
          ...
          description={t('settings.skillsMarket.description', {
            defaultValue: '同步 ClawHub、LoopHub 与 SkillHub 最新榜单，选择技能后交给 GeekClaw 生成安装确认草稿。',
          })}
