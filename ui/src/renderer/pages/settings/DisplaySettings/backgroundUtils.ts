...
export const BACKGROUND_BLOCK_START = '/* GeekClaw Theme Background Start */';
export const BACKGROUND_BLOCK_END = '/* GeekClaw Theme Background End */';
export const BACKGROUND_MASK_VERSION = '/* GeekClaw Theme Background Mask v2 */';
...
:root {
  --geekclaw-manual-bg-mask: ${LIGHT_IMAGE_MASK};
}

html[data-theme='dark'] {
  --geekclaw-manual-bg-mask: ${DARK_IMAGE_MASK};
}
...
.app-shell {
  background-image:
    linear-gradient(var(--geekclaw-manual-bg-mask), var(--geekclaw-manual-bg-mask)),
    url("${imageDataUrl}");
