  ...
  return (
    <MarketSettingsPanel
      ...
      description={t('settings.presetMarket.description', {
        defaultValue: 'Browse SkillHub expert packages and add them as reusable GeekClaw presets.',
      })}
      sources={PRESET_MARKET_SOURCES}
      cacheKey='geekclaw.presetMarket.rankings.v1'
      autoSyncKey='geekclaw.presetMarket.autoSynced.v1'
