...
/**
 * Curated catalog of the external CLI agents GeekClaw knows how to detect.
 *
 ...
 * openclaw); `geekclaw` (internal, always available) and remote agents are
 ...
 * is product-owned, current, and low-risk enough for GeekClaw-assisted install.
 */
