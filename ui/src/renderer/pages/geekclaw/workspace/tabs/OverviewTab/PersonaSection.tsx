...
const PersonaSection: React.FC<PersonaSectionProps> = ({ profile, patchCompanion, refresh }) => {
  ...
  return (
    ...
    >
      <NomiSettingList>
        <NomiSettingRow
          title={t('geekclaw.overview.personaTitle', { defaultValue: '角色介绍' })}
          description={t('geekclaw.settings.personaHint', {
          ...
          controls={
            ...
            >
              <NomiSelect.Option value='lively'>
                {t('geekclaw.settings.personaLively', { defaultValue: '活泼' })}
              </NomiSelect.Option>
              <NomiSelect.Option value='calm'>{t('geekclaw.settings.personaCalm', { defaultValue: '沉稳' })}</NomiSelect.Option>
              <NomiSelect.Option value='sassy'>
                {t('geekclaw.settings.personaSassy', { defaultValue: '小毒舌' })}
              </NomiSelect.Option>
            </NomiSelect>
          }
          footer={
            <Input.TextArea
              ...
              placeholder={t('geekclaw.settings.personaCustomPlaceholder', {
        ...
        <NomiSettingRow
          title={t('geekclaw.settings.preset', { defaultValue: '复用设定' })}
          description={t('geekclaw.settings.presetHint', {
