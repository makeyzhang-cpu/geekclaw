...
const TAB_LABEL_KEYS: Record<WorkspaceTabKey, { key: string; zh: string }> = {
  overview: { key: 'geekclaw.tabs.overview', zh: '总览' },
  memory: { key: 'geekclaw.tabs.memory', zh: '记忆&知识库' },
  remote: { key: 'geekclaw.tabs.remote', zh: '远程控制' },
  evolution: { key: 'geekclaw.tabs.evolution', zh: '进化' },
  skills: { key: 'geekclaw.tabs.skills', zh: '技能' },
  history: { key: 'geekclaw.tabs.history', zh: '聊天历史' },
  other: { key: 'geekclaw.tabs.other', zh: '其他' },
};
