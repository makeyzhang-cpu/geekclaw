    ...
    <>
      ...
      >
            ...
            >
              ...
              <div className='flex items-center gap-6px'>
                ...
                <span className={classNames('text-13px font-600', active ? 'text-[var(--color-primary)]' : 'text-t-primary')}>
                  {t(`geekclaw.characters.${c.nameKey}.name`)}
                </span>
              </div>
            ...
            >
              ...
              <FigureActionSurface>
                <FigureActionButton
                  tone='danger'
                  disabled={used}
                  title={used ? t('geekclaw.customFigure.inUseCannotDelete') : t('geekclaw.customFigure.delete')}
                  ariaLabel={used ? t('geekclaw.customFigure.inUseCannotDelete') : t('geekclaw.customFigure.delete')}
                  onClick={(e) => {
                    e.stopPropagation();
              ...
              <span className='text-11px text-t-tertiary'>{t('geekclaw.customFigure.cardLabel')}</span>
            </div>
          );
        })}
        ...
        >
          ...
          <span className='text-13px font-600 text-t-primary'>{t('geekclaw.customFigure.createNew')}</span>
          <span className='text-11px text-t-tertiary text-center leading-snug'>{t('geekclaw.customFigure.cardHint')}</span>
        </div>
      </div>
