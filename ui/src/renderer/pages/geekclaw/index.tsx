...
const SIDER_STORAGE_KEY = 'geekclaw:geekclaw-sider-width';
...
const NomiWorkspacePage: React.FC = () => {
  ...
  const requestDelete = useCallback(
    (target: ICompanionWithStatus) => {
      Modal.confirm({
        title: t('geekclaw.settings.deleteConfirmTitle'),
        content: t('geekclaw.danger.deleteConfirmBody', {
        ...
        onOk: async () => {
          try {
            ...
            Message.success(t('geekclaw.settings.deleted', { companionName: target.name }));
