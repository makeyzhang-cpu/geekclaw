 ...
 * 未知/缺失 code → 退回通用兜底 `geekclaw.companion.chatError`(原"走神"文案)。
 */
...
export function companionErrorKey(code: string): string {
  switch (code) {
    ...
    case 'USER_LLM_PROVIDER_CONFIG_ERROR':
      return 'geekclaw.companion.err.auth';
    ...
    case 'USER_LLM_PROVIDER_INVALID_TOOL_SCHEMA':
      return 'geekclaw.companion.err.model';
    case 'USER_LLM_PROVIDER_NETWORK_ERROR':
      return 'geekclaw.companion.err.network';
    case 'USER_LLM_PROVIDER_RATE_LIMITED':
      return 'geekclaw.companion.err.rateLimited';
    case 'USER_LLM_PROVIDER_TIMEOUT':
      return 'geekclaw.companion.err.timeout';
    case 'USER_LLM_PROVIDER_GATEWAY_ERROR':
    case 'UNKNOWN_UPSTREAM_ERROR':
      return 'geekclaw.companion.err.gateway';
    case 'USER_LLM_PROVIDER_CONTEXT_TOO_LARGE':
      return 'geekclaw.companion.err.contextTooLarge';
    case 'USER_LLM_PROVIDER_EMPTY_RESPONSE':
      return 'geekclaw.companion.err.empty';
    default:
      return 'geekclaw.companion.chatError';
  }
}
