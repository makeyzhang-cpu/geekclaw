...
const Mochi: React.FC<CharacterProps> = ({ mood, activity, size = 150 }) => {
  ...
  return (
    <div className={`geekclaw-ch geekclaw-mochi geekclaw-mochi--${mood} geekclaw-mochi--${activity}`} style={{ width: size, height: size }}>
      <style>{`
.geekclaw-mochi { position: relative; display: inline-block; }
.geekclaw-mochi svg { display: block; overflow: visible; }
.geekclaw-mochi * { transform-box: view-box; }

/* ground shadow — counter-scales against body lift */
.geekclaw-mochi__shadow { transform-origin: 80px 147px; animation: geekclaw-mochi-shadow 3.4s ease-in-out infinite; }
@keyframes geekclaw-mochi-shadow { 0%,100%{ transform: scale(1); opacity:.13 } 50%{ transform: scale(.9); opacity:.09 } }

/* whole-body mochi squash & breathe */
.geekclaw-mochi__body-g { transform-origin: 80px 138px; animation: geekclaw-mochi-breathe 3.4s ease-in-out infinite; }
@keyframes geekclaw-mochi-breathe {
  0%,100%{ transform: translateY(0) scaleY(1) scaleX(1) }
  50%{ transform: translateY(-2px) scaleY(1.035) scaleX(.975) }
}

/* ears — soft alternate sway */
.geekclaw-mochi__ear-l { transform-origin: 64px 44px; animation: geekclaw-mochi-earL 3.6s ease-in-out infinite; }
.geekclaw-mochi__ear-r { transform-origin: 96px 44px; animation: geekclaw-mochi-earR 3.6s ease-in-out infinite; }
@keyframes geekclaw-mochi-earL { 0%,100%{ transform: rotate(2deg) } 50%{ transform: rotate(-5deg) } }
@keyframes geekclaw-mochi-earR { 0%,100%{ transform: rotate(-2deg) } 50%{ transform: rotate(5deg) } }

/* blink — periodic squash */
.geekclaw-mochi__eyes { transform-origin: 80px 92px; animation: geekclaw-mochi-blink 5s ease-in-out infinite; }
@keyframes geekclaw-mochi-blink { 0%,92%,100%{ transform: scaleY(1) } 95%{ transform: scaleY(.08) } }
.geekclaw-mochi--sleepy .geekclaw-mochi__eyes { animation: none; }

/* mouth chew while thinking */
.geekclaw-mochi__mouth { transform-origin: 80px 104px; }
.geekclaw-mochi--thinking .geekclaw-mochi__mouth { animation: geekclaw-mochi-chew .55s ease-in-out infinite; }
@keyframes geekclaw-mochi-chew { 0%,100%{ transform: scaleY(1) translateY(0) } 50%{ transform: scaleY(.6) translateY(1px) } }

/* happy / excited bounce overrides */
.geekclaw-mochi--happy .geekclaw-mochi__body-g { animation: geekclaw-mochi-hop 1.5s ease-in-out infinite; }
@keyframes geekclaw-mochi-hop {
...
.geekclaw-mochi--excited .geekclaw-mochi__body-g { animation: geekclaw-mochi-jump 1s ease-in-out infinite; }
@keyframes geekclaw-mochi-jump {
...
.geekclaw-mochi--sleepy .geekclaw-mochi__body-g { animation: geekclaw-mochi-doze 4s ease-in-out infinite; }
@keyframes geekclaw-mochi-doze { 0%,100%{ transform: translateY(2px) scaleY(.985) } 50%{ transform: translateY(4px) scaleY(.965) } }

/* sleepy Z's */
.geekclaw-mochi__z { opacity: 0; }
.geekclaw-mochi--sleepy .geekclaw-mochi__z1 { animation: geekclaw-mochi-z 3s ease-in-out infinite; }
.geekclaw-mochi--sleepy .geekclaw-mochi__z2 { animation: geekclaw-mochi-z 3s ease-in-out infinite 1.5s; }
@keyframes geekclaw-mochi-z {
...
/* worried sweat drop */
.geekclaw-mochi__sweat { opacity: 0; }
.geekclaw-mochi--worried .geekclaw-mochi__sweat { animation: geekclaw-mochi-sweat 2.8s ease-in-out infinite; }
@keyframes geekclaw-mochi-sweat {
...
.geekclaw-mochi__spark { opacity: 0; transform-origin: center; }
.geekclaw-mochi--excited .geekclaw-mochi__spark1 { animation: geekclaw-mochi-spark 1.1s ease-in-out infinite; }
.geekclaw-mochi--excited .geekclaw-mochi__spark2 { animation: geekclaw-mochi-spark 1.1s ease-in-out infinite .4s; }
.geekclaw-mochi--excited .geekclaw-mochi__spark3 { animation: geekclaw-mochi-spark 1.1s ease-in-out infinite .75s; }
@keyframes geekclaw-mochi-spark { 0%,100%{ opacity:0; transform: scale(.4) } 45%{ opacity:1; transform: scale(1.1) } }

/* thinking bubbles — small to large, serial float */
.geekclaw-mochi__tb { opacity: 0; }
.geekclaw-mochi--thinking .geekclaw-mochi__tb1 { animation: geekclaw-mochi-tb 2.4s ease-in-out infinite; }
.geekclaw-mochi--thinking .geekclaw-mochi__tb2 { animation: geekclaw-mochi-tb 2.4s ease-in-out infinite .35s; }
.geekclaw-mochi--thinking .geekclaw-mochi__tb3 { animation: geekclaw-mochi-tb 2.4s ease-in-out infinite .7s; }
@keyframes geekclaw-mochi-tb {
  ...
  75%{ opacity:.8 } 100%{ opacity:0; transform: translateY(-9px) scale(1) }
      ...
      <svg viewBox='0 0 160 160' width={size} height={size}>
        ...
        {/* ground shadow */}
        <ellipse className='geekclaw-mochi__shadow' cx='80' cy='147' rx='38' ry='8' fill='#000000' opacity='0.12' />

        <g className='geekclaw-mochi__body-g'>
          {/* ===== EARS (behind body) ===== */}
          <g className='geekclaw-mochi__ear-l'>
          ...
          <g className='geekclaw-mochi__ear-r'>
          ...
          {/* ===== EYES ===== */}
          <g className='geekclaw-mochi__eyes'>
            {isSleepy ? (
              <>
          ...
          <g className='geekclaw-mochi__mouth'>
            {isSleepy ? (
          ...
          {/* worried sweat */}
          <g className='geekclaw-mochi__sweat'>
        ...
        {isSleepy && (
          <g fill='#b79be0' fontFamily='sans-serif' fontWeight='700'>
            <text className='geekclaw-mochi__z geekclaw-mochi__z1' x='104' y='48' fontSize='13'>z</text>
            <text className='geekclaw-mochi__z geekclaw-mochi__z2' x='112' y='38' fontSize='17'>Z</text>
          </g>
        )}
        ...
        {isExcited && (
          <g fill='#ffd84d'>
            <path className='geekclaw-mochi__spark geekclaw-mochi__spark1' d='M118 60 l2 5 5 2 -5 2 -2 5 -2 -5 -5 -2 5 -2 Z' />
            <path className='geekclaw-mochi__spark geekclaw-mochi__spark2' d='M40 56 l1.6 4 4 1.6 -4 1.6 -1.6 4 -1.6 -4 -4 -1.6 4 -1.6 Z' />
            <path className='geekclaw-mochi__spark geekclaw-mochi__spark3' d='M128 88 l1.4 3.5 3.5 1.4 -3.5 1.4 -1.4 3.5 -1.4 -3.5 -3.5 -1.4 3.5 -1.4 Z' />
          </g>
        )}
        ...
        {isThinking && (
          <g>
            <circle className='geekclaw-mochi__tb geekclaw-mochi__tb1' cx='112' cy='52' r='3' fill='url(#mochiBubble)' stroke='#f3b9cb' strokeWidth='0.8' />
            <circle className='geekclaw-mochi__tb geekclaw-mochi__tb2' cx='120' cy='42' r='4.5' fill='url(#mochiBubble)' stroke='#f3b9cb' strokeWidth='0.8' />
            <circle className='geekclaw-mochi__tb geekclaw-mochi__tb3' cx='130' cy='30' r='6.5' fill='url(#mochiBubble)' stroke='#f3b9cb' strokeWidth='0.9' />
          </g>
        )}
      </svg>
    </div>
