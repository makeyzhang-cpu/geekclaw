...
const CFIG_CSS = `
.geekclaw-cfig { position: relative; line-height: 0; }
.geekclaw-cfig img { display: block; -webkit-user-drag: none; }

/* ground shadow, pulsing against the breath */
.geekclaw-cfig__shadow {
  ...
  animation: geekclaw-cfig-shadow 3.6s ease-in-out infinite;
}
@keyframes geekclaw-cfig-shadow { 0%,100% { transform: scaleX(1); opacity: 1; } 50% { transform: scaleX(.95); opacity: .72; } }
...
.geekclaw-cfig__all { position: relative; width: 100%; height: 100%; transform-origin: 50% 100%; animation: geekclaw-cfig-breathe 3.6s ease-in-out infinite; }
@keyframes geekclaw-cfig-breathe { 0%,100% { transform: scaleY(1); } 50% { transform: scaleY(1.008) translateY(-1px); } }
.geekclaw-cfig--happy .geekclaw-cfig__all { animation: geekclaw-cfig-hop 1.7s ease-in-out infinite; }
@keyframes geekclaw-cfig-hop {
  0%,100% { transform: translateY(0); }
  30% { transform: translateY(-7px); }
  55% { transform: translateY(0) scaleY(.997); }
}
.geekclaw-cfig--excited .geekclaw-cfig__all { animation: geekclaw-cfig-jump 1.15s ease-in-out infinite; }
@keyframes geekclaw-cfig-jump {
  0%,100% { transform: translateY(0); }
  40% { transform: translateY(-12px); }
  62% { transform: translateY(-8px); }
  82% { transform: translateY(1px) scaleY(.995); }
}
.geekclaw-cfig--sleepy .geekclaw-cfig__all { animation: geekclaw-cfig-doze 4.6s ease-in-out infinite; }
@keyframes geekclaw-cfig-doze { 0%,100% { transform: translateY(1.5px) rotate(.35deg); } 50% { transform: translateY(3px) rotate(-.35deg); } }
.geekclaw-cfig--worried .geekclaw-cfig__all { animation: geekclaw-cfig-worry 2.6s ease-in-out infinite; }
@keyframes geekclaw-cfig-worry { 0%,100% { transform: translateY(2px) scaleY(.998); } 50% { transform: translateY(3px) scaleY(1.002); } }

.geekclaw-cfig__img { position: absolute; inset: 0; width: 100%; height: 100%; }

/* bust crop is a fixed camera window — light breathing only, never translate */
.geekclaw-cfig__bust-img { position: absolute; max-width: none; transform-origin: 50% 100%; animation: geekclaw-cfig-breathe 3.6s ease-in-out infinite; }

/* particle fx overlay (viewBox 0 0 944 1000) */
.geekclaw-cfig__fx { position: absolute; inset: 0; width: 100%; height: 100%; pointer-events: none; overflow: visible; }
.geekclaw-cfig__fx-el { transform-box: fill-box; transform-origin: 50% 50%; }
.geekclaw-cfig__z, .geekclaw-cfig__sweat, .geekclaw-cfig__spark, .geekclaw-cfig__leaf { opacity: 0; }
.geekclaw-cfig--sleepy .geekclaw-cfig__z1 { animation: geekclaw-cfig-z 3s ease-in-out infinite; }
.geekclaw-cfig--sleepy .geekclaw-cfig__z2 { animation: geekclaw-cfig-z 3s ease-in-out infinite 1.5s; }
@keyframes geekclaw-cfig-z {
  0% { opacity: 0; transform: translate(0,0) scale(.6); }
  25% { opacity: .9; }
  70% { opacity: .65; }
  100% { opacity: 0; transform: translate(32px,-68px) scale(1.1); }
}
.geekclaw-cfig--worried .geekclaw-cfig__sweat { animation: geekclaw-cfig-sweat 2.6s ease-in-out infinite; }
@keyframes geekclaw-cfig-sweat {
  0%,14% { opacity: 0; transform: translateY(0); }
  24% { opacity: .85; }
  72% { opacity: .85; }
  100% { opacity: 0; transform: translateY(45px); }
}
.geekclaw-cfig--excited .geekclaw-cfig__spark1 { animation: geekclaw-cfig-spark 1.1s ease-in-out infinite; }
.geekclaw-cfig--excited .geekclaw-cfig__spark2 { animation: geekclaw-cfig-spark 1.1s ease-in-out infinite .38s; }
.geekclaw-cfig--excited .geekclaw-cfig__spark3 { animation: geekclaw-cfig-spark 1.1s ease-in-out infinite .72s; }
@keyframes geekclaw-cfig-spark { 0%,100% { opacity: 0; transform: scale(.4); } 45% { opacity: 1; transform: scale(1.1); } }
.geekclaw-cfig--thinking .geekclaw-cfig__leaf1 { animation: geekclaw-cfig-leaf 3.4s ease-in-out infinite; }
.geekclaw-cfig--thinking .geekclaw-cfig__leaf2 { animation: geekclaw-cfig-leaf 3.4s ease-in-out infinite 1.7s; }
@keyframes geekclaw-cfig-leaf {
...
const CustomFigure: React.FC<CustomFigureProps> = ({ src, aspect, headBox, mood, activity, size = 150, hitRef }) => {
  ...
  return (
    <div
      className={`geekclaw-ch geekclaw-cfig geekclaw-cfig--${mood} geekclaw-cfig--${activity}${bust ? ' geekclaw-cfig--bust' : ''}`}
      style={{ width: w, height: h, overflow: bust ? 'hidden' : 'visible' }}
    >
      <style>{CFIG_CSS}</style>
      {bust ? (
        <img
          className='geekclaw-cfig__bust-img'
          src={src}
          alt=''
          draggable={false}
          style={{
        ...
        <>
          <div className='geekclaw-cfig__shadow' />
          <div className='geekclaw-cfig__all'>
            <img className='geekclaw-cfig__img' src={src} alt='' draggable={false} />
          </div>

          {/* particle fx (outside the rig so hops don't fling them) */}
          <svg className='geekclaw-cfig__fx' viewBox='0 0 944 1000' aria-hidden='true'>
            <g fontFamily='Georgia, serif' fontWeight='700' fill='#b78757'>
              <text className='geekclaw-cfig__fx-el geekclaw-cfig__z geekclaw-cfig__z1' x='660' y='90' fontSize='40'>z</text>
              <text className='geekclaw-cfig__fx-el geekclaw-cfig__z geekclaw-cfig__z2' x='720' y='55' fontSize='54'>z</text>
            </g>
            <path
              className='geekclaw-cfig__fx-el geekclaw-cfig__sweat'
            ...
            />
            <g fill='#ffd23f'>
              <path className='geekclaw-cfig__fx-el geekclaw-cfig__spark geekclaw-cfig__spark1' d={starPath(180, 330, 26, 7)} />
              <path className='geekclaw-cfig__fx-el geekclaw-cfig__spark geekclaw-cfig__spark2' d={starPath(800, 430, 21, 6)} />
              <path className='geekclaw-cfig__fx-el geekclaw-cfig__spark geekclaw-cfig__spark3' d={starPath(150, 700, 17, 5)} />
            </g>
            <g className='geekclaw-cfig__fx-el geekclaw-cfig__leaf geekclaw-cfig__leaf1'>
              <path d='M560 60 q 25 -18 45 0 q -20 25 -45 0 Z' fill='#c84a3a' stroke='#9c3528' strokeWidth='3' />
            </g>
            <g className='geekclaw-cfig__fx-el geekclaw-cfig__leaf geekclaw-cfig__leaf2'>
