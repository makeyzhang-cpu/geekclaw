...
const extractNameAndArgs = (
  ...
  // tool_call（geekclaw 引擎）：{ name, args, ... }
...
export const browserNarrationFor = (data: unknown): BrowserNarration | null => {
  ...
  switch (action) {
    ...
    case 'open_link_new_tab': {
      ...
      return host
        ? { key: 'geekclaw.companion.browser.navigate', params: { host } }
        : { key: 'geekclaw.companion.browser.busy', params: {} };
    }
    case 'click':
      return { key: 'geekclaw.companion.browser.click', params: {} };
    case 'type':
    case 'set_value':
      return { key: 'geekclaw.companion.browser.type', params: {} };
    case 'observe':
      return { key: 'geekclaw.companion.browser.observe', params: {} };
    case 'screenshot':
      return { key: 'geekclaw.companion.browser.screenshot', params: {} };
    case 'extract':
    case 'get_page_text':
      return { key: 'geekclaw.companion.browser.read', params: {} };
    case 'search_page':
    case 'scroll_to_text':
    case 'find_elements': {
      const q = truncate(str(args, 'query') || str(args, 'text') || str(args, 'selector'), 30);
      return q
        ? { key: 'geekclaw.companion.browser.search', params: { query: q } }
        : { key: 'geekclaw.companion.browser.busy', params: {} };
    }
    case 'download':
    case 'save_as_pdf':
      return { key: 'geekclaw.companion.browser.download', params: {} };
    case 'scroll':
    case 'press_key':
    case 'hover':
    case 'select_option':
    ...
    default:
      ...
      return { key: 'geekclaw.companion.browser.busy', params: {} };
  }
};
