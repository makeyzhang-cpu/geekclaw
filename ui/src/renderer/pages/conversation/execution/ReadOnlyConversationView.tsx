...
const NomiChat = React.lazy(() => import('@/renderer/pages/conversation/platforms/geekclaw/NomiChat'));
...
// Narrow to GeekClaw conversations so model field is always available
type NomiConversation = Extract<TChatConversation, { type: 'geekclaw' }>;

/** GeekClaw sub-component supplies locked model state without adding a ChatLayout wrapper. */
