...
function StepNodeImpl({ data, selected }: NodeProps<StepFlowNode>) {
  ...
  const quickLook = (
    <div className='geekclaw-dag-quick-look'>
      <div className='geekclaw-dag-quick-look-header'>
        <span className='geekclaw-dag-quick-look-dot' style={{ background: meta.color }} />
        <strong>{data.title}</strong>
        <span style={{ color: meta.color }}>{data.statusLabel}</span>
      </div>
      {data.spec && <p className='geekclaw-dag-quick-look-spec'>{data.spec}</p>}
      {(data.outputSummary || data.errorSummary) && (
        <div className='geekclaw-dag-quick-look-result'>
          <span>{data.quickLookLabels.result}</span>
          <p>{data.errorSummary || data.outputSummary}</p>
        </div>
      )}
      <div className='geekclaw-dag-quick-look-meta'>
      ...
      <div className='geekclaw-dag-quick-look-relations'>
        <div>
      ...
      <div className='geekclaw-dag-quick-look-hint'>{data.quickLookLabels.inspect}</div>
    </div>
  );
  ...
  return (
    <Popover
      ...
      className='geekclaw-dag-quick-look-popover'
      content={quickLook}
      unmountOnExit
    >
      <div
        className='geekclaw-dag-node-shell geekclaw-dag-enter'
      ...
      >
        ...
        >
          <span
            className={`geekclaw-dag-status-dot ${meta.pulse ? 'geekclaw-dag-pulse' : ''}`}
            style={{ background: meta.color }}
          />
          <span className='geekclaw-dag-node-copy'>
            <span className='geekclaw-dag-node-title'>{data.title}</span>
            <span className='geekclaw-dag-node-summary' style={{ color: hasQuestion ? 'var(--warning)' : undefined }}>
          ...
          <span className='geekclaw-dag-node-aside'>
            {kindBadge && (
              <span
                className='geekclaw-dag-kind-icon'
            ...
            <span className='geekclaw-dag-relation-counts' aria-hidden='true'>
