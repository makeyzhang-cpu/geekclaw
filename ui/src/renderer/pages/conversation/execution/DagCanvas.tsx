      ...
      <div className='flex-1 min-h-0'>
        {activeSteps.length === 0 ? (
          <div className='flex size-full flex-col items-center justify-center gap-10px px-24px text-center'>
            <Branch className='geekclaw-dag-pulse text-primary-6' theme='outline' size='26' />
            <strong>
          ...
          >
            ...
            <Panel position='top-right' className='geekclaw-dag-toolbar'>
              <Tooltip content={t('agentExecution.canvas.fit', { defaultValue: '适应视图' })} position='bottom'>
                <button
                  type='button'
                  className='geekclaw-dag-toolbar-button'
            ...
            {overviewOpen && (
              <MiniMap
                ...
                className='geekclaw-dag-minimap'
