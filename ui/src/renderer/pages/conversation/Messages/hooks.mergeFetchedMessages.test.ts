        ...
        artifacts: [
          {
            ...
            relative_path: 'geekclaw-artifacts/stale.png',
            size_bytes: 10,
            sha256: 'a'.repeat(64),
          },
        ],
          ...
          content: [
            {
              ...
              artifact: {
                ...
                relative_path: 'geekclaw-artifacts/stale-acp.png',
                size_bytes: 10,
                sha256: 'b'.repeat(64),
              },
            },
...
describe('composeMessageForTest', () => {
        ...
        artifacts: [
          {
            ...
            relative_path: 'geekclaw-artifacts/old.png',
            size_bytes: 10,
            sha256: 'a'.repeat(64),
          },
        ],
  ...
  test('keeps live agent status separate from text sharing the same turn msg_id', () => {
    ...
    const status = baseMessage({
      ...
      type: 'agent_status',
      position: 'left',
      content: { backend: 'geekclaw', status: 'preparing', agent_name: 'GeekClaw' },
    });
  ...
  test('updates the same live agent status lifecycle without appending duplicates', () => {
    ...
    const updated = {
      ...status,
      created_at: 2000,
      content: { backend: 'geekclaw', status: 'prepared', agent_name: 'GeekClaw' },
    } as TMessage;
...
describe('normalizeDbMessage', () => {
  const persistedArtifact = {
    ...
    relative_path: 'geekclaw-artifacts/image.png',
    size_bytes: 10,
    sha256: 'c'.repeat(64),
  };
