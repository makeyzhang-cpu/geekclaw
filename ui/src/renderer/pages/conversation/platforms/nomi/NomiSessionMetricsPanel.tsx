...
const NomiSessionMetricsPanel: React.FC<{ conversation: TChatConversation }> = ({ conversation }) => {
  ...
  useEffect(() => {
    return addEventListener('geekclaw.usage.updated', ({ conversation_id, tokenUsage }) => {
  ...
  return (
    <div className='w-full p-12px pb-16px box-border text-t-primary' data-testid='geekclaw-session-metrics-panel'>
