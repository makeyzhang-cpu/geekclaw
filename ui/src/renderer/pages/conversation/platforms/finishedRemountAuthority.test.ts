...
} from './geekclaw/nomiLifecycleFence';
import {
  IDLE_EXECUTION_GATE,
...
describe('Finished conversation remount authority', () => {
  test('late old started/stream/completed plus remount stays idle and sends no POST', async () => {
    ...
    // GeekClaw/ACP passive mount first performs an authoritative GET. Finished is
    ...
    // Delayed old output cannot raise Remote/OpenClaw/Nanobot, GeekClaw, or ACP.
    expect(
      shouldAcceptAuthoritativeStreamActivity({
