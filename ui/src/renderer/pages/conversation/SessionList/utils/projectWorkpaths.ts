...
export const PROJECT_WORKPATHS_STORAGE_KEY = 'geekclaw:session-list-project-workpaths';
const PROJECT_WORKPATHS_CHANGED_EVENT = 'geekclaw:session-list-project-workpaths-changed';
