...
export const WORKPATH_EXPANSION_STORAGE_KEY = 'geekclaw:workpath-expansion';
export const WORKPATH_SUBGROUP_STORAGE_KEY = 'geekclaw:workpath-subgroup-expansion';
export const COMPANION_GROUP_STORAGE_KEY = 'geekclaw:companion-group-expanded';
export const SSH_GROUP_STORAGE_KEY = 'geekclaw:ssh-group-expanded';

const WORKPATH_UI_EVENT = 'geekclaw:workpath-ui-changed';
