...
type ProviderAgentKey = 'geekclaw';

/** Map agent key → storage key for persisting default model */
const MODEL_STORAGE_KEY: Record<ProviderAgentKey, 'geekclaw.defaultModel'> = {
  geekclaw: 'geekclaw.defaultModel',
};

type PersistedDefaultModel = NonNullable<ConfigKeyMap['geekclaw.defaultModel']>;
 ...
 * @param agentKey - current provider-based agent (currently only 'geekclaw')
 */
export const useGuidModelSelection = (agentKey: ProviderAgentKey = 'geekclaw'): GuidModelSelectionResult => {
