...
describe('Guid collaboration policy', () => {
  test('shares one GeekClaw-only policy control between home and conversation', () => {
    ...
    expect(controlSource.includes("if (runtimeType !== 'geekclaw') return null")).toBe(true);
  ...
  test('stores canonical policy fields on the created GeekClaw conversation', () => {
