...
describe('Guid resource cards placement', () => {
  ...
  test('contains docs, promo video, and contact feedback cards without recent prompt data access', () => {
    ...
    expect(source.includes('https://www.geekclaw.com/docs')).toBe(true);
    ...
    expect(source.includes('https://www.geekclaw.com/contact')).toBe(true);
    expect(source.includes('https://github.com/geekclaw/geekclaw-tauri/issues')).toBe(false);
