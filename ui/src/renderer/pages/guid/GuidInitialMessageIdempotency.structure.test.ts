...
describe('Guid initial-message idempotency', () => {
  ...
  test('GeekClaw QuickStart persists the auto-send key before navigation', () => {
    const source = readSource(
      new URL('../../hooks/agent/useGeekClawQuickStart.ts', import.meta.url)
    );
