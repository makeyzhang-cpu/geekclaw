...
const SIZE_LABEL_KEY = {
  s: 'geekclaw.customFigure.sizeS',
  m: 'geekclaw.customFigure.sizeM',
  l: 'geekclaw.customFigure.sizeL',
} as const;
  ...
  return (
    <div className='flex gap-20px items-start justify-center flex-wrap'>
      ...
      <div className='flex flex-col gap-12px min-w-160px'>
        <span className='text-12px text-t-tertiary leading-snug max-w-200px'>{t('geekclaw.customFigure.frameHint')}</span>
        <div
        ...
        <div className='flex flex-col gap-6px'>
          <div className='flex items-baseline gap-6px'>
            <span className='text-13px text-t-secondary'>{t('geekclaw.customFigure.sizeLabel')}</span>
            <span className='text-11px text-t-tertiary'>{t('geekclaw.customFigure.sizeHint')}</span>
          </div>
