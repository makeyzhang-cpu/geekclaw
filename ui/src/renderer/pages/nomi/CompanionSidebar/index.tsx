    ...
    >
      <div className='relative shrink-0'>
        ...
        <span
          ...
          title={modelReady ? undefined : t('geekclaw.chat.modelUnset')}
        />
      </div>
      ...
      <div className='shrink-0 flex items-center gap-2px opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity'>
        <InstantHoverTooltip content={t('geekclaw.companions.reorder', { defaultValue: '拖动调整位置' })}>
          ...
          <div
            aria-label={t('geekclaw.companions.reorder', { defaultValue: '拖动调整位置' })}
        ...
        <InstantHoverTooltip content={t('geekclaw.settings.deleteCompanion')}>
          <div
            role='button'
            aria-label={t('geekclaw.settings.deleteCompanion')}
            onClick={(event) => {
      ...
      header={
        <div className='px-8px pt-12px pb-8px'>
          ...
          >
            ...
            <span className='truncate'>{t('geekclaw.companions.create')}</span>
          </div>
        </div>
      }
      footer={
...
export const confirmDeleteCompanion = async (
  ...
  try {
    ...
    Message.success(t('geekclaw.settings.deleted', { companionName: companion.name }));
