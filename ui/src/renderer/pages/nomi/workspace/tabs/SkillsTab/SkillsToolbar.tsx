  ...
  return (
    <div className='flex flex-wrap items-center gap-10px'>
      <SegmentedTabs
        ...
        items={[
          { key: 'all', label: t('geekclaw.skills.filterAll', { defaultValue: '全部' }) },
          {
            key: 'generated',
            label: t('geekclaw.skills.sourceGenerated', { defaultValue: '自动生成' }),
            dot: hasDrafts,
          },
          { key: 'catalog', label: t('geekclaw.skills.sourceCatalog', { defaultValue: '已配置' }) },
        ]}
      />
      <div className='ml-auto flex items-center gap-8px'>
        ...
        >
          {t('geekclaw.skills.learnFromSession', { defaultValue: '从会话学习' })}
        </SkillButton>
        <SkillButton
          tone='primary'
        ...
        >
          {t('geekclaw.skills.addCapability', { defaultValue: '添加能力' })}
        </SkillButton>
      </div>
    </div>
  );
