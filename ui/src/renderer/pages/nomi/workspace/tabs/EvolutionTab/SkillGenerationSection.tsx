...
const SkillGenerationSection: React.FC<Props> = ({ config }) => {
  ...
  return (
    ...
    >
      <NomiSettingList>
        <NomiSettingRow
          title={t('geekclaw.evolve.enabled', { defaultValue: '开启技能进化' })}
          description={t('geekclaw.evolution.skillEnabledDesc', {
        ...
        />
        <NomiSettingRow
          title={t('geekclaw.evolution.preferenceTitle', { defaultValue: '生成偏好' })}
          description={t('geekclaw.evolution.preferenceDesc', {
          ...
          footer={
            <div className='flex gap-8px max-[760px]:flex-col'>
              <ModeCard
                ...
                title={t('geekclaw.evolution.preferenceConservative', { defaultValue: '保守' })}
                description={t('geekclaw.evolution.preferenceConservativeDesc', {
              ...
              <ModeCard
                ...
                title={t('geekclaw.evolution.preferenceAggressive', { defaultValue: '激进' })}
                description={t('geekclaw.evolution.preferenceAggressiveDesc', {
        ...
        />
        <NomiSettingRow
          title={t('geekclaw.evolution.minSessions', { defaultValue: '最少出现会话数' })}
          description={t('geekclaw.evolution.minSessionsDesc', {
          ...
          controls={
            <NumberSetting
              ...
              suffix={t('geekclaw.evolution.sessionsUnit', { defaultValue: '个会话' })}
            />
          }
        />
      </NomiSettingList>
