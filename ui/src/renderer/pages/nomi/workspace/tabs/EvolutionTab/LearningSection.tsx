...
const LearningSection: React.FC<Props> = ({ config, needsModel }) => {
  ...
  return (
    ...
    >
      <NomiSettingList>
        <NomiSettingRow
          title={t('geekclaw.learn.enabled', { defaultValue: '开启定时学习' })}
          description={t('geekclaw.evolution.learnEnabledDesc', {
        ...
        />
        <NomiSettingRow
          title={t('geekclaw.evolution.interval', { defaultValue: '学习周期' })}
          description={t('geekclaw.evolution.intervalDesc', {
          ...
          controls={
            <NumberSetting
              ...
              suffix={t('geekclaw.learn.minutes', { defaultValue: '分钟' })}
            />
          }
        />
