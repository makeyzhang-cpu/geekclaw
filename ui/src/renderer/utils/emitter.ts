...
interface EventTypes {
  'geekclaw.selected.file': [Array<string | FileOrFolderItem>];
  'geekclaw.selected.file.append': [Array<string | FileOrFolderItem>];
  'geekclaw.selected.file.clear': void;
  'geekclaw.workspace.refresh': void;
  'geekclaw.usage.updated': [{ conversation_id: ConversationId; tokenUsage: TokenUsageData }];
