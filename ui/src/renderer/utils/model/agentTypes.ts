...
/** Type of an agent. */
export type AgentType = 'acp' | 'remote' | 'geekclaw' | 'openclaw-gateway' | 'nanobot';
...
export type AgentMetadata = {
  ...
  backend?: string;
  /** Top-level runtime discriminant: "acp" | "remote" | "nanobot" | "geekclaw" | … */
  ...
  /** Native mode id that GeekClaw's legacy `yolo` / `yoloNoSandbox`
