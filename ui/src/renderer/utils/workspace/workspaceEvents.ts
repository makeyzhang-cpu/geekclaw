...
export const WORKSPACE_TOGGLE_EVENT = 'geekclaw-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'geekclaw-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'geekclaw-workspace-has-files';
