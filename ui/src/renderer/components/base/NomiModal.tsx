...
const NomiModal: React.FC<NomiModalProps> = ({
  ...
  return (
    <Modal
      ...
      footer={null}
      onCancel={onCancel}
      className={`geekclaw-modal ${className}`}
      style={finalStyle}
      getPopupContainer={() => document.body}
    >
      <div className='geekclaw-modal-wrapper' style={{ borderRadius: borderRadiusVal }}>
        {renderHeader()}
        <div className='geekclaw-modal-body-content' style={bodyInlineStyle}>
          {children}
        </div>
        {renderFooter()}
      </div>
