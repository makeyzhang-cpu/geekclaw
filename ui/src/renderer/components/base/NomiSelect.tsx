...
/**
 * 基础样式类名
 * 注意：主题相关样式（背景色、边框色）在 arco-override.css 的 .geekclaw-select 类中定义
 * Note: Theme-related styles (background, border colors) are defined in .geekclaw-select class in arco-override.css
 */
 ...
 * ```
 *
 * @see arco-override.css for theme-related styles (.geekclaw-select)
 */
