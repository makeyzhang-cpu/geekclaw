...
const CONTACT_ITEMS = [
  ...
  },
  {
    ...
    fallbackLabel: '官网',
    value: GEEKCLAW_PUBLIC_LINKS.officialWebsite,
    url: GEEKCLAW_PUBLIC_LINKS.officialWebsite,
    copyValue: GEEKCLAW_PUBLIC_LINKS.officialWebsite,
  },
  {
...
const FeedbackReportModal: React.FC<FeedbackReportModalProps> = ({ visible, onCancel }) => {
  ...
  const openContactPage = useCallback(() => {
    void openExternalUrl(GEEKCLAW_PUBLIC_LINKS.contact).catch((e) => console.error('open contact page failed', e));
  }, []);
