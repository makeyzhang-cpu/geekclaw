...
import { GEEKCLAW_PUBLIC_LINKS } from './FeedbackReportModal';
...
const AboutModalContent: React.FC = () => {
  ...
  const checkUpdate = () => {
    ...
    window.dispatchEvent(new CustomEvent('geekclaw-open-update-modal', { detail: { source: 'about' } }));
  };
          ...
          <div className='flex flex-col items-center pb-24px'>
            ...
            {isDesktop && (
              <div className='flex flex-wrap items-center justify-center gap-8px w-full max-w-360px bg-fill-2 p-16px rounded-lg'>
                ...
                <Button
                  onClick={() =>
                    openLink(GEEKCLAW_PUBLIC_LINKS.baiduPan).catch((error) =>
