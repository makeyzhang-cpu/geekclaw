...
const DINGTALK_DEV_DOCS_URL = 'https://github.com/geekclaw/nomifun-app/wiki/DingTalk-Bot-Setup-Guide';
...
const DingTalkConfigForm: React.FC<DingTalkConfigFormProps> = ({
  ...
  const handleAutoEnable = async () => {
    try {
      ...
      if (!result.success) {
        throw new Error(result.error || t('geekclaw.settings.remoteEnableFailed', { defaultValue: 'Failed to enable channel' }));
      }
