...
const SiderNomiEntry: React.FC<SiderNomiEntryProps> = ({
  ...
  if (collapsed) {
    return (
      <Tooltip {...siderTooltipProps} content={t('geekclaw.siderTitle')} position='right'>
        <div
  ...
  return (
    <Tooltip {...siderTooltipProps} content={t('geekclaw.siderTitle')} position='right'>
      ...
      >
        ...
        <span className='collapsed-hidden text-14px font-[500] leading-24px'>{t('geekclaw.siderTitle')}</span>
      </div>
    </Tooltip>
  );
};
