...
interface SiderFactorySupplyEntryProps {
  isMobile: boolean;
  isActive: boolean;
  collapsed: boolean;
...
const SiderFactorySupplyEntry: React.FC<SiderFactorySupplyEntryProps> = ({
  isMobile,
  isActive,
  collapsed,
  siderTooltipProps,
  ...
  const label = t('common.siderRail.factorySupply', { defaultValue: '跨境工厂供货撮合平台' });
...
export default SiderFactorySupplyEntry;
