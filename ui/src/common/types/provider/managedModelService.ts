...
/**
 * Wire-contract types for GeekClaw-managed model services.
 *
...
export const GEEKCLAW_FREE_MODEL_PLATFORM = 'geekclaw-free-model';
...
export const isManagedModelProvider = (provider: { id?: string; platform?: string }): boolean =>
  provider.platform === GEEKCLAW_FREE_MODEL_PLATFORM;
