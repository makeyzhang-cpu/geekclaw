...
GeekClaw can execute local tools, shell commands, browser automation, desktop
automation, and remote capability calls. Treat an authenticated GeekClaw instance
...
- operating system and deployment mode (`geekclaw-desktop`, `nomifun-web`, or
  standalone `geekclaw`),
- reproduction steps,
- impact assessment,
