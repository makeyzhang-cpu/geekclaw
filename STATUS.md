...
- One Cargo workspace:
  - `crates/agent/*`: 15 `geekclaw-*` crates.
  - `crates/backend/*`: 34 `geekclaw-*` crates.
  - `crates/shared/*`: 3 cross-layer crates (`geekclaw-process-runtime`,
    `geekclaw-redact`, `nomifun-net`).
