...
```text
https://github.com/geekclaw/geekclaw-tauri/releases/latest/download/latest.json
```
...
```text
apps/desktop/signing/geekclaw-updater.key
```
...
> `apps/desktop/signing/geekclaw-updater.key` 从密钥库拷过来，且它必须与 `tauri.conf.json`
