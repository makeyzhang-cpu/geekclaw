...
mod tests {
    ...
    fn applications_bundle_on_same_device_is_supported() {
        assert_eq!(
            classify(Some("/Applications/GeekClaw.app"), Some(7), Some(7)),
    ...
    fn mounted_volume_is_rejected_before_device_comparison() {
        assert_eq!(
            classify(Some("/Volumes/GeekClaw/GeekClaw.app"), Some(9), Some(7)),
    ...
    fn app_translocation_is_rejected() {
        assert_eq!(
            classify(
                Some("/private/var/folders/x/AppTranslocation/ABC/d/GeekClaw.app"),
                Some(7),
                Some(7),
            ),
    ...
    fn different_devices_are_rejected() {
        assert_eq!(
            classify(Some("/Users/muri/Apps/GeekClaw.app"), Some(9), Some(7)),
    ...
    fn missing_bundle_or_metadata_fail_closed() {
        ...
        assert_eq!(
            classify(Some("/Applications/GeekClaw.app"), None, Some(7)),
    ...
    fn finds_app_bundle_ancestor_from_executable() {
        assert_eq!(
            app_bundle_from_executable(Path::new("/Applications/GeekClaw.app/Contents/MacOS/GeekClaw")),
            Some(PathBuf::from("/Applications/GeekClaw.app")),
        );
    }
}
