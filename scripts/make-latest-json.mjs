 ...
 *   bun run make:latest --repo owner/name       # 指定 GitHub 仓库（默认 geekclaw/geekclaw-tauri）
...
const DEFAULT_REPO = 'geekclaw/geekclaw-tauri';
...
manifest.notes = notes || readChangelogNotes(version) || `GeekClaw v${version}`;
