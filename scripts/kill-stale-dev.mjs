 ...
 * (`geekclaw-desktop.exe mcp-*-stdio`). If the dev app dies without cleanup
 ...
 * Usage: bun scripts/kill-stale-dev.mjs [binary-name ...]   (default: geekclaw-desktop)
 */
...
if (names.length === 0) names.push('geekclaw-desktop');
